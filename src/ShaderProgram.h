...
namespace GLWRAPPER_NS {
	...
	public:
		...
		void SetUniform(std::string uniform, vec2& vec);
		void SetUniform(std::string uniform, vec3& vec);
		void SetUniform(std::string uniform, vec4& vec);
		void SetUniform(std::string uniform, mat4& mat);
